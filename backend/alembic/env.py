...
from app.models import environment_connection as _environment_connection  # noqa: F401
...
# Models are imported here (as they're added) so Alembic autogenerate can see them.
